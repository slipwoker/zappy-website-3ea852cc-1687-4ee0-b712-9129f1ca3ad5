    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "דיאנה אזולאי תקשור קבלי והכוונה רוחנית משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3ea852cc-1687-4ee0-b712-9129f1ca3ad5',
                    name: data.name || '',
                    email: data.email || '',
